...
const ICONS_MAP = {
    logo: ({className, style}: { className?: string; style?: CSSProperties }) => (
        <svg width="127" height="19" viewBox="0 0 127 19" fill="currentColor" className={className} style={style}>
            <path d="M24.36 15.6V16.68H18.528V15.6H20.904V8.87999H6.408V15.6H8.784V16.68H-3.26335e-06V15.6H2.4V1.07999H-3.26335e-06V-8.58307e-06H21.984V15.6H24.36ZM5.304 1.07999H3.48V15.6H5.304V1.07999ZM20.904 7.79999V1.07999H6.408V7.79999H20.904ZM43.6194 19.008H26.5074V17.928H43.6194V19.008ZM60.6936 13.752H61.7736V16.68H46.7976V5.42399H61.7736V8.35199H60.6936V6.50399H50.8056V15.6H60.6936V13.752ZM49.7256 6.50399H47.8776V15.6H49.7256V6.50399ZM79.2551 15.6H81.6311V16.68H64.2791V10.512H75.2471V6.50399H65.3591V8.35199H64.2791V5.42399H79.2551V15.6ZM75.2471 15.6V11.592H65.3591V15.6H75.2471ZM78.1751 6.50399H76.3271V15.6H78.1751V6.50399ZM98.6017 5.42399V16.68H83.2897V1.07999H80.9137V-8.58307e-06H87.2977V5.42399H98.6017ZM86.2177 1.07999H84.3697V15.6H86.2177V1.07999ZM97.5217 15.6V6.50399H87.2977V15.6H97.5217ZM106.901 15.6H109.277V16.68H100.517V15.6H102.893V1.07999H100.517V-8.58307e-06H106.901V15.6ZM105.821 1.07999H103.973V15.6H105.821V1.07999ZM111.204 5.42399H126.18V11.592H115.212V15.6H125.1V13.752H126.18V16.68H111.204V5.42399ZM115.212 6.50399V10.512H125.1V6.50399H115.212ZM112.284 15.6H114.132V6.50399H112.284V15.6Z" fill="black"/>
        </svg>
    ),
